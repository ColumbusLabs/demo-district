...
| `models/landmark.glb` | Landmark sculpture (lancet arch, crescent wings) | Demo District (generated) | `tools/blender/landmark.py` | Original work generated from code after the approved mockup's silhouette; built with Blender 5.0 (`bpy`) and meshopt-compressed with glTF Transform. |
